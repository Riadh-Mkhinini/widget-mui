  ...
  return {
    ...
    global: {
      ...
      preview: {
        ...
        radius: Number(config?.global?.preview?.radius) || 1,
        background: config?.global?.preview?.background,
        borderWidth: Number(config?.global?.preview?.borderWidth),
      ...
      container: {
        padding: Number(config?.global?.container?.padding),
        background: config?.global?.container?.background,
        borderRadius: Number(config?.global?.container?.borderRadius),
    ...
    calendar: {
      ...
      monthNumberDisplays: Number(config?.calendar?.monthNumberDisplays) || 1,
      maxYear: Number(config?.calendar?.maxYear) || 1,
    ...
    guests: {
      ...
      maxAdults: Number(config?.guests?.maxAdults) || 6,
      maxChildren: Number(config?.guests?.maxChildren) || 6,
      maxAgesChildren: Number(config?.guests?.maxAgesChildren) || 16,
      maxRoom: Number(config?.guests?.maxRoom) || 10,
    },
    search: {
